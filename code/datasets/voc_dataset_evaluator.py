...
def evaluate_boxes(voc_dataset, all_boxes, output_dir, use_salt=True, cleanup=True, test_corloc=False,
                   use_matlab=False):
...
def _do_matlab_eval(voc_dataset, salt, eval_det=True, output_dir='output'):
    ...
    cmd_det = cmd + '"voc_eval (\'{:s}\',\'{:s}\',\'{:s}\',\'{:s}\',{:d},{:d},{:s});"'.format(devkit_path,
                                                                                              'comp4' + salt,
                                                                                              voc_dataset.image_set,
                                                                                              output_path, dev_kit_year,
                                                                                              dataset_year, 'false')
