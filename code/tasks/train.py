...
from ..utils import optimizer_utils as optimizer_utils
from ..utils import misc as misc_utils
from ..utils import data_transforms as dt_trans
...
def parse_args():
    ...
    parser.add_argument('--bs', dest='batch_size',
                        help='Explicitly specify to overwrite the value comed from cfg_file.', type=int, default=1)
    ...
    parser.add_argument('--use_tfboard', help='Use tensorflow tensorboard to log training info', type=bool,
                        default=True)
