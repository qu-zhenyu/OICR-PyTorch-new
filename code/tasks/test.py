...
def test_net_on_dataset(args, dataset, detections, use_matlab=True, early_stop=False):
    ...
    voc_eval = voc_dataset_evaluator.evaluate_boxes(dataset, final_boxes, args.output_dir, test_corloc=test_corloc,
...
def parse_args():
    ...
    parser.add_argument('--output_dir',
                        help='output directory to save the testing results. If not provided, defaults to [args.load_ckpt|args.load_detectron]/../test.')

    parser.add_argument('--set', dest='set_cfgs',
                        help='set config keys, will overwrite config in the cfg_file. See lib/core/config.py for all options',
                        default=[], nargs='*')
